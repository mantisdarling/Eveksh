  ...
  return (
    <div className="min-h-screen w-full text-[#D3DAD9] flex flex-col justify-between items-center p-4 sm:p-6 relative" style={{ backgroundColor: '#37353E' }}>
      ...
      <header className="relative z-10 w-full max-w-5xl flex items-center justify-between py-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            ...
            className="text-xs font-mono text-[#a3a69f] hover:text-white transition-colors"
          >
            Already have an account? <span className="text-[#D3DAD9] font-semibold underline underline-offset-4">Sign in</span>
          </Link>
        </div>
      </header>
      ...
      <div className="relative z-10 w-full max-w-[440px] my-auto">
        <div className="p-8 sm:p-9 space-y-5 shadow-2xl border border-[rgba(211,218,217,0.16)] bg-[#44444E] rounded-2xl">
          ...
          {/* Role Switcher */}
          <div className="grid grid-cols-2 p-1 bg-[#37353E] border border-[rgba(211,218,217,0.14)] rounded-xl gap-1">
            <button
              type="button"
              onClick={() => setRole('LEARNER')}
              className={`py-1.5 rounded-lg text-xs font-medium transition-all ${
                role === 'LEARNER' ? 'bg-[#715A5A] text-[#D3DAD9] font-semibold shadow-sm' : 'text-[#a3a69f] hover:text-white'
              }`}
            >
              Learner
            </button>
            <button
              ...
              className={`py-1.5 rounded-lg text-xs font-medium transition-all ${
                role === 'EXPERT' ? 'bg-[#715A5A] text-[#D3DAD9] font-semibold shadow-sm' : 'text-[#a3a69f] hover:text-white'
              }`}
            >
              Mentor
            </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div>
              <label className="block text-xs font-medium text-[#D3DAD9] mb-1" htmlFor="register-email">
                Email address
              </label>
              <input
                id="register-email"
            ...
            <div>
              <label className="block text-xs font-medium text-[#D3DAD9] mb-1" htmlFor="register-password">
                Password
              </label>
              <input
            ...
            <div className="pt-2">
              <Link
                href={`/${locale}/dashboard`}
                className="btn-midday-secondary w-full py-2.5 rounded-xl text-xs font-medium text-center text-[#D3DAD9] hover:text-white border border-[rgba(211,218,217,0.16)] block shadow-sm"
              >
