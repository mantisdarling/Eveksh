    ...
    <div style={{ minHeight: '100vh', background: '#09090b', color: '#fafafa' }}>
      ...
      <main style={{ maxWidth: 1000, margin: '0 auto', padding: '6rem 1.5rem 4rem' }}>
        <div className="animate-fade-in-up" style={{ marginBottom: '2rem' }}>
          <h1 style={{ fontSize: '2rem', fontWeight: 900, letterSpacing: '-0.03em' }}>Book a Session</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.4fr', gap: '1.5rem', alignItems: 'start' }}>
          ...
          <div className="glass-panel" style={{ borderRadius: '1.25rem', padding: '2rem' }}>
            <div style={{ width: 64, height: 64, borderRadius: '50%', background: '#27272a', border: '1px solid #3f3f46', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.6rem', fontWeight: 700, color: '#fff', marginBottom: '1.25rem' }}>E</div>
